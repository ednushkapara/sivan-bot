...
2. אם יש timestamp על ההודעה בתמונה (למשל "MAY 6 AT 15:43") — השתמשי בו בתור Last Communication
3. הוסיפי ליד עם כל הפרטים כולל location אם הוזכר
4. אחרי יצירת הליד — רשמי בפירוש מה הוספת ומה לא נמצא בתמונה
5. הציעי טיוטת תגובה שעדן יכול להעתיק ולשלוח
